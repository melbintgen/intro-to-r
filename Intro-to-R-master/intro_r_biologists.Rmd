...
**Your turn 3.5:** Option 2: type the name of the object and this will
...
**Your turn 3.7:** Check the column and row names used in in
...
**Your turn 3.8:** Work out what the following commands mean, then
...
**Your turn 3.10:** Do the same to rename the first column name from
...
**Your turn 8.1:** Download the Rmarkdown template
[here](https://melbintgen.github.io/intro-to-r/Rmd_template.zip). Copy
the content of this folder **into** your Working directory.
...
1.  We will look at the 'breast_tumors.csv', 'gene_description.txt' and
    ...
    (from readxl). Name each file appropriately. NOTE: you will still
    need to load readxl explicitly, because it is not a core tidyverse
    package loaded via library(tidyverse).
