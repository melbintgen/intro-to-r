...
*R looks in the working directory by default to
...
**Your turn 1.4:** Save the script you created in the previous section as
...
**Your turn 2.1:** Compare these two outputs. In the second line we use the
function `sum`.
...
**Your turn 3.1:** Load your tidyverse library. If you get an error message,
...
Unzip the file and **store the content in the `data` folder in your working directory**.
...
**Your turn 3.3:** Load the data into your R working directory. We will store
...
No need to be overwhelmed by the outputs! It contains information regarding  "column specification" (telling us that there is a missing
column name in the header and it has been filled with the name "...1",
which is how read_csv handles missing column names by default). We will fix this later. It also
...
**Your turn 3.4:** Option 1: Click on the `counts` object in your global
environment panel on the right-hand-side of RStudio. It will open a new
Tab.

**Your turn 3.5:** Option 2: type the name of the object and this will print
...
**Your turn 3.6:** Check how many rows and columns are in `sampleinfo`.
...
**Your turn 3.7:** Check the column and row names used in in `sampleinfo`. Comment on the results you get. 
...
**Your turn 3.8:** Work out what the following commands mean, then include
...
**Your turn 3.9:** Describe what the next command line is doing:
...
**Your turn 3.10:** Do the same to rename the first column name from "\...1"
...
**Your turn 5.1:** Type each command line above, then look at the data. Check
...
**Your turn 6.1:** Run the following command line. Identify the key functions
...
**Your turn 6.2:** Boxplots are useful summaries, but hide the shape of the distribution.
...
**Your turn 6.3:** Get the help file for `geom_boxplot` and scroll down to
...
**Your turn 6.5:** Run the code above and look at `mygenes_counts`, what did
it do?
...
**Your turn 8.1:** Download the Rmarkdown template [here](https://melbintgen.github.io/intro-to-r/Rmd_template.zip). Copy the content of
...
**Your turn 8.2:** Together, let's go through the different steps of
...
At the end of your report, we recommend you run the `sessionInfo()` function which prints out details about your working environment such as the version of
R yo are running, loaded packages, and package versions. Printing out
