...
In general we use the console to perform quick tests or run single lines of code, whilst
scripts are used to run more complex analysis. We will write in a script for the rest of our workshop
as this is the best practice for reproducible research.
:::
